...
<html>
    ...
    <div class="row justify-content-center align-items-center">
        <div class="col-md-8 text-center">
            <h1>Welcome to the One Piece Fan Page</h1>
            <p>This is a fan page for the anime and manga series One Piece. Here you can find information about the series, characters, and more. Enjoy!</p>
        </div>
    </div>
</div>
<div>
